...
const Navbar = ({ setShowLogin }) => {
    ...
    return (
        <div className="navbar">
            <img src={assets.logo} alt="Logo" className="logo" onClick={() => navigate('/')} style={{cursor: 'pointer'}} />

            <div className="navbar-right">

                <div className="language-switch">
                    <button
                        className={`lang-btn ${i18n.language === 'vi' ? 'active-lang' : ''}`}
                ...
                {!token ? (
                    ...
                    <div className="navbar-profile">
                        ...
                        <ul className="nav-profile-dropdown">
                            <li onClick={() => navigate('/shopprofile')}>
                                <p>{t('shop_info')}</p>
                            </li>
                            <li onClick={logout}>
                                <p>{t('logout')}</p>
